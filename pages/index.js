            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                  <span className="block text-white">UI/UX, web and</span>
                  <span className="block text-indigo-200">mobile aplications</span>
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                  We are  a small company developing small or mid sized mobile and web
                  applications. Mobile apps are developed for Android and as well for iOS
                </p>
              </div>
            </div>
          </div>
        ...
        */}
        ...
        <div className="bg-gradient-to-r from-purple-800 to-indigo-700">
          <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
            <h2 className="text-3xl font-extrabold text-white tracking-tight">Services we offer</h2>
            <p className="mt-4 max-w-3xl text-lg text-purple-200">
              Applia is a small company with a big vision and
              futuristic plans for its growths and excelent service
            </p>
